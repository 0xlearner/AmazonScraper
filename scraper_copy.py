...
class GenerateReport:
    ...
    def get_best_item(self):
        try:
            return sorted(
                self.data["products"], key=lambda k: k["rating"], reverse=True
            )[0]
...
class AmazonAPI:
    ...
    def get_title(self, url):
        ...
        try:
            return _session.html.find("span#productTitle", first=True).text
        except Exception as e:
            print(e)
    ...
    def get_seller(self, url):
        ...
        _session.html.render(timeout=60)
        try:
            return _session.html.find("a#bylineInfo", first=True).text
        except Exception as e:
            print(e)
    ...
    def get_price(self, url):
        ...
        _session.html.render(timeout=60)
        try:
            price_1 = float(_session.html.find("span.apexPriceToPay", first=True))
            if price_1 is not None:
                price = price_1.text.split("$")[1]
            else:
                price = float(
                    _session.html.find(
            ...
            try:
                ...
                if "In Stock." or None in availability:
                    ...
                    price = availability.split("\n")[0]
                elif "Currently unavailable." in availability_message:
                    price = availability_message.split("\n")[0]
    ...
    def get_review_count(self, url):
        ...
        try:
            return _session.html.find(
                "span#acrCustomerReviewText", first=True
            ).text.split(" ")[0]
        except Exception as e:
            print(e)
